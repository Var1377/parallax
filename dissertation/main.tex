...
\usepackage[numbers, sort&compress, super]{natbib} % For bibliography with superscript citations
...
\usetikzlibrary{positioning, shapes, arrows.meta} % Add useful TikZ libraries
\usepackage{tikz-multinets} % Use tikz-multinets instead
\usetikzlibrary{calc} % Add calc library for coordinate calculations
\usepackage{listings, listings-rust} % For code listings
