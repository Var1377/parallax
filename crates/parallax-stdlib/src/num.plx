...
impl BitAnd for u8 { fn bitand(self, other: Self) -> Self = __intrinsic_u8_and__(self, other); }
impl BitOr for u8 { fn bitor(self, other: Self) -> Self = __intrinsic_u8_or__(self, other); }
impl BitXor for u8 { fn bitxor(self, other: Self) -> Self = __intrinsic_u8_xor__(self, other); }
impl BitNot for u8 { fn bitnot(self) -> Self = __intrinsic_u8_not__(self); }
impl BitShiftLeft for u8 { fn shl(self, other: Self) -> Self = __intrinsic_u8_shl__(self, other); }
impl BitShiftRight for u8 { fn shr(self, other: Self) -> Self = __intrinsic_u8_shr__(self, other); }
...
impl BitAnd for u16 { fn bitand(self, other: Self) -> Self = __intrinsic_u16_and__(self, other); }
impl BitOr for u16 { fn bitor(self, other: Self) -> Self = __intrinsic_u16_or__(self, other); }
impl BitXor for u16 { fn bitxor(self, other: Self) -> Self = __intrinsic_u16_xor__(self, other); }
impl BitNot for u16 { fn bitnot(self) -> Self = __intrinsic_u16_not__(self); }
impl BitShiftLeft for u16 { fn shl(self, other: Self) -> Self = __intrinsic_u16_shl__(self, other); }
impl BitShiftRight for u16 { fn shr(self, other: Self) -> Self = __intrinsic_u16_shr__(self, other); }
...
impl BitAnd for u32 { fn bitand(self, other: Self) -> Self = __intrinsic_u32_and__(self, other); }
impl BitOr for u32 { fn bitor(self, other: Self) -> Self = __intrinsic_u32_or__(self, other); }
impl BitXor for u32 { fn bitxor(self, other: Self) -> Self = __intrinsic_u32_xor__(self, other); }
impl BitNot for u32 { fn bitnot(self) -> Self = __intrinsic_u32_not__(self); }
impl BitShiftLeft for u32 { fn shl(self, other: Self) -> Self = __intrinsic_u32_shl__(self, other); }
impl BitShiftRight for u32 { fn shr(self, other: Self) -> Self = __intrinsic_u32_shr__(self, other); }
...
impl BitAnd for u64 { fn bitand(self, other: Self) -> Self = __intrinsic_u64_and__(self, other); }
impl BitOr for u64 { fn bitor(self, other: Self) -> Self = __intrinsic_u64_or__(self, other); }
impl BitXor for u64 { fn bitxor(self, other: Self) -> Self = __intrinsic_u64_xor__(self, other); }
impl BitNot for u64 { fn bitnot(self) -> Self = __intrinsic_u64_not__(self); }
impl BitShiftLeft for u64 { fn shl(self, other: Self) -> Self = __intrinsic_u64_shl__(self, other); }
impl BitShiftRight for u64 { fn shr(self, other: Self) -> Self = __intrinsic_u64_shr__(self, other); }
...
impl BitAnd for u128 { fn bitand(self, other: Self) -> Self = __intrinsic_u128_and__(self, other); }
impl BitOr for u128 { fn bitor(self, other: Self) -> Self = __intrinsic_u128_or__(self, other); }
impl BitXor for u128 { fn bitxor(self, other: Self) -> Self = __intrinsic_u128_xor__(self, other); }
impl BitNot for u128 { fn bitnot(self) -> Self = __intrinsic_u128_not__(self); }
impl BitShiftLeft for u128 { fn shl(self, other: Self) -> Self = __intrinsic_u128_shl__(self, other); }
impl BitShiftRight for u128 { fn shr(self, other: Self) -> Self = __intrinsic_u128_shr__(self, other); }
...
impl BitAnd for i8 { fn bitand(self, other: Self) -> Self = __intrinsic_i8_and__(self, other); }
impl BitOr for i8 { fn bitor(self, other: Self) -> Self = __intrinsic_i8_or__(self, other); }
impl BitXor for i8 { fn bitxor(self, other: Self) -> Self = __intrinsic_i8_xor__(self, other); }
impl BitNot for i8 { fn bitnot(self) -> Self = __intrinsic_i8_not__(self); }
impl BitShiftLeft for i8 { fn shl(self, other: Self) -> Self = __intrinsic_i8_shl__(self, other); }
impl BitShiftRight for i8 { fn shr(self, other: Self) -> Self = __intrinsic_i8_shr__(self, other); }
...
impl BitAnd for i16 { fn bitand(self, other: Self) -> Self = __intrinsic_i16_and__(self, other); }
impl BitOr for i16 { fn bitor(self, other: Self) -> Self = __intrinsic_i16_or__(self, other); }
impl BitXor for i16 { fn bitxor(self, other: Self) -> Self = __intrinsic_i16_xor__(self, other); }
impl BitNot for i16 { fn bitnot(self) -> Self = __intrinsic_i16_not__(self); }
impl BitShiftLeft for i16 { fn shl(self, other: Self) -> Self = __intrinsic_i16_shl__(self, other); }
impl BitShiftRight for i16 { fn shr(self, other: Self) -> Self = __intrinsic_i16_shr__(self, other); }
...
impl BitAnd for i32 { fn bitand(self, other: Self) -> Self = __intrinsic_i32_and__(self, other); }
impl BitOr for i32 { fn bitor(self, other: Self) -> Self = __intrinsic_i32_or__(self, other); }
impl BitXor for i32 { fn bitxor(self, other: Self) -> Self = __intrinsic_i32_xor__(self, other); }
impl BitNot for i32 { fn bitnot(self) -> Self = __intrinsic_i32_not__(self); }
impl BitShiftLeft for i32 { fn shl(self, other: Self) -> Self = __intrinsic_i32_shl__(self, other); }
impl BitShiftRight for i32 { fn shr(self, other: Self) -> Self = __intrinsic_i32_shr__(self, other); }
...
impl BitAnd for i64 { fn bitand(self, other: Self) -> Self = __intrinsic_i64_and__(self, other); }
impl BitOr for i64 { fn bitor(self, other: Self) -> Self = __intrinsic_i64_or__(self, other); }
impl BitXor for i64 { fn bitxor(self, other: Self) -> Self = __intrinsic_i64_xor__(self, other); }
impl BitNot for i64 { fn bitnot(self) -> Self = __intrinsic_i64_not__(self); }
impl BitShiftLeft for i64 { fn shl(self, other: Self) -> Self = __intrinsic_i64_shl__(self, other); }
impl BitShiftRight for i64 { fn shr(self, other: Self) -> Self = __intrinsic_i64_shr__(self, other); }
...
impl BitAnd for i128 { fn bitand(self, other: Self) -> Self = __intrinsic_i128_and__(self, other); }
impl BitOr for i128 { fn bitor(self, other: Self) -> Self = __intrinsic_i128_or__(self, other); }
impl BitXor for i128 { fn bitxor(self, other: Self) -> Self = __intrinsic_i128_xor__(self, other); }
impl BitNot for i128 { fn bitnot(self) -> Self = __intrinsic_i128_not__(self); }
impl BitShiftLeft for i128 { fn shl(self, other: Self) -> Self = __intrinsic_i128_shl__(self, other); }
impl BitShiftRight for i128 { fn shr(self, other: Self) -> Self = __intrinsic_i128_shr__(self, other); }
...
pub fn __intrinsic_bool_ne__(lhs: bool, rhs: bool) -> bool;
...
pub fn __intrinsic_i128_to_u64__(val: i128) -> Option<u64>;
pub fn __intrinsic_i128_to_u128__(val: i128) -> Option<u128>;

// Unsigned to Signed
pub fn __intrinsic_u8_to_i8__(val: u8) -> Option<i8>;
pub fn __intrinsic_u8_to_i16__(val: u8) -> i16;
pub fn __intrinsic_u8_to_i32__(val: u8) -> i32;
pub fn __intrinsic_u8_to_i64__(val: u8) -> i64;
pub fn __intrinsic_u8_to_i128__(val: u8) -> i128;
pub fn __intrinsic_u16_to_i8__(val: u16) -> Option<i8>;
pub fn __intrinsic_u16_to_i16__(val: u16) -> Option<i16>;
pub fn __intrinsic_u16_to_i32__(val: u16) -> i32;
pub fn __intrinsic_u16_to_i64__(val: u16) -> i64;
pub fn __intrinsic_u16_to_i128__(val: u16) -> i128;
pub fn __intrinsic_u32_to_i8__(val: u32) -> Option<i8>;
pub fn __intrinsic_u32_to_i16__(val: u32) -> Option<i16>;
pub fn __intrinsic_u32_to_i32__(val: u32) -> Option<i32>;
pub fn __intrinsic_u32_to_i64__(val: u32) -> i64;
pub fn __intrinsic_u32_to_i128__(val: u32) -> i128;
pub fn __intrinsic_u64_to_i8__(val: u64) -> Option<i8>;
pub fn __intrinsic_u64_to_i16__(val: u64) -> Option<i16>;
pub fn __intrinsic_u64_to_i32__(val: u64) -> Option<i32>;
pub fn __intrinsic_u64_to_i64__(val: u64) -> Option<i64>;
pub fn __intrinsic_u64_to_i128__(val: u64) -> i128;
pub fn __intrinsic_u128_to_i8__(val: u128) -> Option<i8>;
pub fn __intrinsic_u128_to_i16__(val: u128) -> Option<i16>;
pub fn __intrinsic_u128_to_i32__(val: u128) -> Option<i32>;
pub fn __intrinsic_u128_to_i64__(val: u128) -> Option<i64>;
pub fn __intrinsic_u128_to_i128__(val: u128) -> Option<i128>;
