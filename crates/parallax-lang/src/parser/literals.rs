...
pub fn parse_literal(node: &Node, source: &str) -> Result<Literal, ParallaxError> {
    match node.kind() {
        "literal" => {
...
pub fn parse_string_literal(node: &Node, source: &str) -> Result<Literal, ParallaxError> {
    println!("Parsing string literal: {}", node.to_sexp());
...
pub fn parse_integer_literal(node: &Node, source: &str) -> Result<Literal, ParallaxError> {
    println!("Parsing integer literal: {}", node.to_sexp());
...
pub fn parse_float_literal(node: &Node, source: &str) -> Result<Literal, ParallaxError> {
    println!("Parsing float literal: {}", node.to_sexp());
...
pub fn parse_boolean_literal(node: &Node, source: &str) -> Result<Literal, ParallaxError> {
    println!("Parsing boolean literal: {}", node.to_sexp());
...
pub fn parse_character_literal(node: &Node, source: &str) -> Result<Literal, ParallaxError> {
    println!("Parsing character literal: {}", node.to_sexp());
...
fn process_string_escapes(content: &str) -> Result<String, ParallaxError> {
                    ...
                    'u' => {
                        ...
                        loop {
                            match chars.next() {
                                ...
                                Some(c) => return Err(ParallaxError::ParseError {
                                    message: format!("Invalid character '{}' in unicode escape", c),
                                    span: None,
                                }),
                                None => return Err(ParallaxError::ParseError {
...
fn process_character_escape(content: &str) -> Result<String, ParallaxError> {
...
mod tests {
    ...
    #[test]
    fn test_string_literal() -> Result<(), ParallaxError> {
    ...
    #[test]
    fn test_string_literal_with_escapes() -> Result<(), ParallaxError> {
    ...
    #[test]
    fn test_raw_string_literal() -> Result<(), ParallaxError> {
    ...
    #[test]
    fn test_integer_literal_decimal() -> Result<(), ParallaxError> {
    ...
    #[test]
    fn test_integer_literal_hex() -> Result<(), ParallaxError> {
    ...
    #[test]
    fn test_float_literal() -> Result<(), ParallaxError> {
    ...
    #[test]
    fn test_integer_literal_with_suffix() -> Result<(), ParallaxError> {
