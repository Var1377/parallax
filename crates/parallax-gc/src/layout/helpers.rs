use crate::layout::descriptor::{LayoutDescriptor, DescriptorIndex};
...
pub fn type_needs_heap_allocation(
    ...
    descriptor_indices: &mut dyn Fn(&HirType) -> Result<DescriptorIndex, LayoutError>,
    ...
    match hir_type {
        ...
        // Arrays need heap allocation if elements need it or array is large
