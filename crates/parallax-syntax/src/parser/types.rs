...
pub fn parse_type(node: &Node, source: &str) -> Result<Type, SyntaxError> {
...
mod tests {
    ...
    fn test_type_node(source: &str) -> Result<Type, SyntaxError> {
    ...
    #[test]
    fn test_simple_path_type() -> Result<(), SyntaxError> {
    ...
    fn test_complex_path_type() -> Result<(), SyntaxError> {
        ...
        match ty.kind {
            TypeKind::Path(path) => {
                ...
                assert_eq!(path[1].name, "collections");
                assert_eq!(path[2].name, "HashMap");
            },
            _ => panic!("Expected path type"),
        }
        Ok(())
    ...
    #[test]
    fn test_simple_function_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_multi_param_function_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_no_param_function_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_no_return_function_type() -> Result<(), SyntaxError> {
        let ty = test_type_node("fn main(f: fn(i32)) = ();")?;
        match ty.kind {
            TypeKind::Function(param, ret) => {
                match param.kind {
    ...
    #[test]
    fn test_nested_function_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_empty_tuple_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_single_element_tuple_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_multi_element_tuple_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_array_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_nested_array_type() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_simple_kind_app() -> Result<(), SyntaxError> {
            ...
            TypeKind::KindApp(base, args) => {
                match &base.kind {
                    TypeKind::Path(path) => {
                        ...
                        assert_eq!(path[0].name, "Option", "Expected path to be Option");
                    },
                ...
                match &args[0].kind {
                    TypeKind::Path(path) => {
                        ...
                        assert_eq!(path[0].name, "i32", "Expected path to be i32");
                    },
    ...
    #[test]
    fn test_complex_kind_app() -> Result<(), SyntaxError> {
            ...
            TypeKind::KindApp(base, args) => {
                match &base.kind {
                    TypeKind::Path(path) => {
                        ...
                        assert_eq!(path[0].name, "Result", "Expected path to be Result");
                    },
                    _ => panic!("Expected path type for base"),
                }
                    ...
                    TypeKind::KindApp(inner_base, inner_args) => {
                        match &inner_base.kind {
                            TypeKind::Path(path) => {
                                ...
                                assert_eq!(path[0].name, "Vec", "Expected path to be Vec");
                            },
                ...
                match &args[1].kind {
                    TypeKind::Path(path) => {
                        ...
                        assert_eq!(path[0].name, "Error", "Expected path to be Error");
                    },
    ...
    #[test]
    fn test_mixed_complex_type() -> Result<(), SyntaxError> {
        let ty = test_type_node("fn main(x: Result<(fn(i32) -> String, [bool; 4]), Vec<Error>>) = ();")?;
        match ty.kind {
            TypeKind::KindApp(base, args) => {
                // Check Result base
                match &base.kind {
                    TypeKind::Path(path) => assert_eq!(path[0].name, "Result"),
                    _ => panic!("Expected path type for base"),
                }
                ...
                match &args[1].kind {
                    TypeKind::KindApp(vec_base, vec_args) => {
                        ...
                        match &vec_args[0].kind {
                            TypeKind::Path(path) => assert_eq!(path[0].name, "Error"),
    ...
    #[test]
    fn test_function_with_generic_return() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_nested_function_with_generic() -> Result<(), SyntaxError> {
    ...
    #[test]
    fn test_nested_kind_app() -> Result<(), SyntaxError> {
                    ...
                    TypeKind::KindApp(inner_base, inner_args) => {
                        ...
                        match &inner_args[0].kind {
                            TypeKind::Path(path) => {
                                ...
                                assert_eq!(path[0].name, "T", "Expected path to be T");
                            },
                        ...
                        match &inner_args[1].kind {
                            TypeKind::Path(path) => {
                                ...
                                assert_eq!(path[0].name, "E", "Expected path to be E");
                            },
    ...
    #[test]
    fn test_function_with_complex_param() -> Result<(), SyntaxError> {
                    ...
                    TypeKind::KindApp(base, args) => {
                        ...
                        match &args[0].kind {
                            TypeKind::Path(path) => {
                                ...
                                assert_eq!(path[0].name, "U", "Expected path to be U");
                            },
                            _ => panic!("Expected path type for return type argument"),
                        }
                    },
    ...
    #[test]
    fn test_qualified_path() -> Result<(), SyntaxError> {
